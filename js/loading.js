 ...
 * 
*/
var c= document.getElementById("c"),        // 获取画布节点
    ctx = c.getContext('2d'),               // 依据画布获取画笔
    cw = c.width = 300,                     // 获取画布宽度并赋值给画布
    ch = c.height = 280,                    // 获取画布高度并赋值给画布
    rand = function(a,b){
    ...
    renderCircle = function(){
        ...
        ctx.beginPath();
        ctx.arc( 0 , 0 , circle.radius , dToR(circle.angleEnd) , true );
